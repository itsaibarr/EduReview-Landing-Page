...
const PROBLEMS = [
  {
    Icon: EyeOff,
    title: 'Effort stays invisible',
    body: 'You work hard — but nothing shows it. No way to see or share your real progress beyond a score on a page.',
  },
  {
    Icon: TrendingDown,
    title: 'Grades flatten reality',
    body: 'One bad week can erase months of growth. A single number can\'t capture a trajectory or reflect real momentum.',
  },
  {
    Icon: Compass,
    title: 'Motivation loses direction',
    body: 'When progress isn\'t visible, it\'s hard to know if you\'re improving — or why pushing harder even matters.',
  },
]
      ...
      <div className="max-w-[1100px] mx-auto">
        ...
        <FadeUp delay={0.1} className="mt-4 text-center">
          <h2 className="text-h1 font-bold text-text-primary leading-[1.1] tracking-[-0.03em] max-w-[580px] mx-auto">
            You&apos;re growing.
            <br />
            The system doesn&apos;t <span className="text-brand">see it.</span>
          </h2>
          <p className="mt-5 text-body-lg text-text-secondary max-w-[480px] mx-auto leading-relaxed">
            Grades measure outcomes, not effort. Real learning momentum stays
            hidden — from you, your teachers, and everyone else.
          </p>
        </FadeUp>
